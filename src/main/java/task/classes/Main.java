...
import static task.util.CommonUtils.*;
import static task.util.FreedmanUtils.*;
import static task.util.VisionerCypherUtils.shiftNTimes;
import static task.util.VisionerCypherUtils.visionerCypher;
